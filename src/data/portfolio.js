export const portfolioData = [
  ...
  },
  {
    ...
    image: "/img-los.png",
    stack: ["React.js", "Node.js", "SQL Server"],
    urlApp: "",
    urlGithub: "",
  },
  {
    ...
    description:
      "This website is a news portal that I created using vanilla JavaScript, without a framework. I implemented several things in its development including API integration, DOM manipulation, and responsive design.",
  ...
  },
  {
    ...
    description:
      "The idea of this application is an application that can be used by administrators to manage the system. It features user management, role-based access control, and analytics dashboard.",
  ...
  },
  {
    ...
    description:
      "Welcome to our Restaurant Catalog, an exploration of the finest dining establishments in various cities and countries. From traditional flavors to creative innovations, we've curated places worth experiencing.",
