...
import image from "../../assets/image/img-restologi.png";
const RestologiPage = () => {
  return (
    <>
      <figure className="relative h-[80vh] w-full">
        ...
        <figcaption
         ...
         -translate-x-2/4 justify-between rounded-xl 
          py-4 px-6 shadow-lg  
          bg-gradient-to-r from-pink-500 shadow-black/5 saturate-200 backdrop-blur-sm">
          <div>
            <Typography variant="h4" color="white" className="font-normal">
              Restologi
            </Typography>
            <Typography className="mt-2 font-normal text-white">
              Welcome to our Restaurant Catalog, an exploration of the finest
              dining establishments in various cities and countries. From
              traditional flavors to creative innovations, we have curated
              places worth experiencing, bringing you an unforgettable culinary
              adventure.
            </Typography>
            ...
            <Button
              ...
              onClick={() => {
                window.open("https://muhamadwindy.github.io/restologi");
              }}>
              <svg
