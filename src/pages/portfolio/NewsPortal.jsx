...
import image from "../../assets/image/img-sulistiyo-news.png";
         ...
         shadow-black/5 saturate-200 backdrop-blur-sm">
          <div>
            ...
            <Typography className="mt-2 font-normal text-white">
              This website is a news portal that I created using vanilla
              JavaScript, or you could say without a framework. I implemented
              several things in its development, such as using custom elements,
              leveraging APIs to fetch data with AXIOS, using tailwindCSS to
              enhance the appearance, and employing webpack as the module
              bundler.
            </Typography>
            ...
            <Button
              ...
              onClick={() => {
                window.open("https://muhamadwindy.github.io/sulistiyo-news/");
              }}>
              <svg
