...
import image from "../../assets/image/img-admin-app.png";
       ...
       shadow-black/5 saturate-200 backdrop-blur-sm">
          <div>
            ...
            <Typography className="mt-2 font-normal text-white">
              The idea of this application is an application that can be used by
              administrators to manage the system. For example, I created a form
              to manage application users. I used vanilla JavaScript in building
              this application and applied styling from the Tailwind CDN. I
              implemented several techniques commonly used in developing
              JavaScript-based applications, namely DOM manipulation, Events,
              and Web Storage to enhance functionality and interactivity.
            </Typography>
            ...
            <Button
              ...
              onClick={() => {
                window.open("https://muhamadwindy.github.io/admin-app/");
              }}>
              <svg
