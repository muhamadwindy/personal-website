...
import image from "../../assets/image/img-company-profile.png";
     ...
     shadow-black/5 saturate-200 backdrop-blur-sm">
          <div>
            <Typography variant="h4" color="white" className="font-normal">
              Sulistiyo | Finance And Banking Leading IT Company
            </Typography>
            <Typography className="mt-2 font-normal text-white">
              In developing this company profile website, I used basic HTML,
              CSS, and JavaScript. I created this website to sharpen my skills
              in implementing attractive and semantic application interfaces,
              responsive layouts, and JavaScript DOM manipulation.
            </Typography>
