...
import imgSection from "../assets/image/nggon-about.png";
const AboutPage = () => {
  return (
    <div>
      ...
      <div className="lg:flex justify-between mt-4">
        <div className="lg:w-[50%]">
          ...
          <div className="mt-3 font-bold shadow-lg rounded-xl p-5 border-2 lg:w-max">
            ...
            <div className="flex gap-2 pt-3 text-sm text-center ">
              <a
                href="https://github.com/muhamadwindy"
                target="_blank"
                rel="noreferrer"
                className="min-w-20 hover:-translate-y-1 hover:scale-100 duration-300">
                <svg
                  ...
                  height="40"
                  viewBox="0 0 50 50"
                  className="block m-auto fill-indigo-500">
        ...
        <div className="lg:w-[40%]">
          <img
            src={imgSection}
            alt="Gambar e"
            className="w-full hover:-translate-y-1 hover:scale-200 duration-100"
          />
        </div>
      </div>
    </div>
