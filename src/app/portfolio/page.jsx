...
const featured = {
  ...
  category: "Enterprise",
  description:
    "Enterprise-grade web application for financial and banking companies, handling the complete loan origination workflow — from application intake through multi-stage underwriting, approval, and disbursement — with role-based access control and compliance audit trails.",
  image: "/img-los.png",
...
const projects = [
  {
    ...
    category: "Enterprise",
    description:
      "Admin dashboard with user management, role-based access control, activity logging, and real-time analytics for system administrators.",
  ...
  },
  {
    ...
    category: "Web",
    description:
      "Semantic, responsive company profile with smooth scroll animations and clean layouts — built entirely from scratch without frameworks.",
  ...
  },
  {
    ...
    category: "Web",
    description:
      "Live news portal powered by a REST API with category filtering, full-text search, and lazy-loaded images for fast performance.",
  ...
  },
  {
    ...
    category: "PWA",
    description:
      "Restaurant discovery PWA with offline support via Service Workers, installable on home screen, and WCAG accessibility compliance.",
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-14">
          ...
          <div className="flex items-center gap-3 flex-wrap pb-1">
            {[
              ...
              <div
                key={s.label}
                className="flex flex-col items-center px-4 py-2 glass-card rounded-xl">
          ...
          {projects.map((project) => (
            <div
              ...
              <div className="relative h-48 overflow-hidden flex-shrink-0">
                ...
                <div className="absolute inset-0 bg-violet-900/85 dark:bg-violet-950/90 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-3">
                  <Link
                    ...
                    className="bg-white text-violet-700 text-xs font-bold px-4 py-2 rounded-xl hover:bg-violet-50 transition-colors shadow-lg">
                    View Details
                  </Link>
                  {project.urlApp && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="bg-white/15 backdrop-blur-sm text-white text-xs font-medium px-3 py-2 rounded-xl hover:bg-white/25 transition-colors border border-white/20">
                      Live ↗
                    </a>
                  )}
                </div>

                {/* Category + number (always visible) */}
                <div className="absolute top-3 left-3 right-3 flex items-center justify-between">
                  <CategoryBadge cat={project.category} />
                  <span className="text-xs font-bold font-mono text-white/60 bg-black/30 backdrop-blur-sm px-2 py-1 rounded-md">
                    {project.num}
                  </span>
                </div>
              </div>
              ...
              <div className="p-5 flex flex-col flex-grow">
                ...
                <p className="text-xs text-gray-600 dark:text-gray-400 leading-relaxed line-clamp-2 flex-grow mb-4">
                  {project.description}
                </p>
                ...
                <div className="flex items-center gap-3 pt-3 border-t border-gray-100 dark:border-white/5">
                  ...
                  {project.urlApp && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="text-xs text-gray-500 hover:text-gray-800 dark:hover:text-gray-200 transition-colors ml-auto">
                      Open ↗
                    </a>
                  )}
                </div>
